...
![请求列表](/image/mockm_api_list_2020-09-21_100140.png)
...
- **replay**
  ![replay](/image/mockm_replay_2020-11-10-11-21-51.png)
...
- **capture**
  ![capture](/image/mockm_capture_2020-11-10-11-29-22.png)
...
- **swagger**
  ![swagger](/image/mockm_swagger_2020-11-10-11-32-18.png)
...
- **history**
  ![history](/image/mockm_history_2020-11-10-11-33-26.png)
...
![请求详情](/image/mockm_api_detail_2020-09-21_100052.png)

::: details 参考
![请求](/image/HTTP_ReqExample.png)

![响应](/image/HTTP_ResExample.png)
...
![apiWebEdit](/image/mockm_apiWebEdit_2020-11-10-14-03-22.png)
...
![apiWebEdit](/image/mockm_apiWebEdit_2020-11-10-14-05-27.png)
...
![apiWebEdit](/image/mockm_apiWebEdit_2020-11-10-14-07-10.png)
...
![apiWebEdit](/image/mockm_apiWebEdit_2020-12-03-10-44-49.png)

输入请求 ID, 请求当前接口时, 总是返回所输入请求 ID 的响应, 包括 headers 以及其中的测试链接也总是一样的.
