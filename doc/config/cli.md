...
1. 你没有指定 NPM_CONFIG_REGISTRY 环境变量,
1. package.json 中有以下 scripts `"dev": "mockm"`,
1. 当你运行 `yarn dev` 时, yarn 会自动把 NPM_CONFIG_REGISTRY 值设置为 `https://registry.yarnpkg.com/`, 这与第 2 步冲突了.
